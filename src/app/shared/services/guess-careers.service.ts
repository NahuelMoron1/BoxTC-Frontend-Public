...
import { GuessCareers, GuessCareersComplete } from '../models/GuessCareers';
...
export class GuessCareersService {
  ...
  constructor() {
    ...
    this.myApiUrl = 'api/guess-careers/';
  }
  ...
  getGame(): Observable<GuessCareersComplete> {
    return this.http.get<GuessCareersComplete>(`${this.myAppUrl}${this.myApiUrl}play`);
  }
